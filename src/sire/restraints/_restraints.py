__all__ = ["angle", "boresch", "bond", "dihedral", "distance", "morse_potential", "moving_harmonic", "positional", "rmsd", "soft_angle"]
...
def moving_harmonic(
    mols, atoms0, atoms1, r0=None, k=None, r1=None, name=None, map=None
):
    """
    Create a set of distance restraints from all of the atoms in 'atoms0'
    to all of the atoms in 'atoms1' where all atoms are
    ...
    If k is None, then a default value of 5 kcal mol-1 A-2 will be used.
    """
    ...
    from .. import u
    from ..base import create_map
    from ..mm import MovingHarmonicRestraint, MovingHarmonicRestraints
    ...
    if name is None:
        restraints = MovingHarmonicRestraints()
    else:
        restraints = MovingHarmonicRestraints(name=name)
    ...
    for i, (atom0, atom1) in enumerate(zip(atoms0, atoms1)):
        ...
        restraints.add(MovingHarmonicRestraint(idxs0[0], idxs1[0], ik, ir0, r1))
